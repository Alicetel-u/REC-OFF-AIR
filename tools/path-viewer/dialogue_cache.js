const DIALOGUE_CACHE = {
  "ch01_haison_iriguchi": {
    ...
    "events": [
      ...
      },
      {
        ...
        "reading": "さて……あるきながらせつめいするね。あたしいま、おふだをさんまいもってるの。じんじゃをやっているわたしのおばあちゃんからパク",
        "voice": "v003"
      },
      {
        "type": "wait",
      ...
      {
        "type": "say",
        "text": "……正直、足が震えてる。さっきのトイレのこと、まだ頭から離れない。",
        "voice": "v049"
      },
      {
        "type": "wait",
      ...
      {
        "type": "say",
        "text": "……ありがと。うん。行く。逃げたら一生後悔する気がする。",
        "voice": "v052"
      },
      {
        "type": "wait",
      ...
      {
        "type": "_comment",
        "_": "── Phase3: 反転（覚悟を決めた → 承認欲求に飲まれていく） ──"
      },
      {
        "type": "say",
  ...
  "ch02_haison_souko": {
    ...
    "voice_dir": "res://assets/audio/voice/ch02_souko/",
    "chat_voice_dir": "res://assets/audio/voice/ch02_souko_chat/",
    "_note": "第2章：廃倉庫 ─ 保存された絶叫 ─ CP1暗転から継続→紙芝居→自由移動",
    "events": [
      {
        "type": "_comment",
        "_": "══════════════════════════════════════"
      ...
      {
        "type": "say",
        "text": "DMで言ってた『証拠VHS』がある廃倉庫だ。配信的には、ここで証拠をゲットするのがセオリーだよね。",
        "voice": "v101b"
      },
      {
        "type": "wait",
      ...
      {
        "type": "say",
        "text": "みんな同接5万超えてるの見えてる？　これ、今夜で10万いくかもよ。",
        "reading": "みんなどうせつ5万超えてるの見えてる？　これ、今夜で10万いくかもよ。",
        "voice": "v102a"
      },
      {
        "type": "wait",
      ...
      {
        "type": "sfx",
        "file": "metal/impactMetal_heavy_000.mp3"
      },
      {
        "type": "camera_shake",
        "intensity": 0.3,
      ...
      {
        "type": "say",
        "text": "埃っぽい……棚がいっぱい。VHSテープがどこかにあるはず。",
        "voice": "v103a"
      },
      {
        "type": "wait",
  ...
  "ch02_haison_souko_found": {
    ...
    "voice_dir": "res://assets/audio/voice/ch02_souko/",
    "_note": "VHS発見時の演出（v102のみ）",
    "events": [
      {
        "type": "say",
        "text": "あ、あった！ ラベルに『1994_10_記録』って書いてある。これ、私が生まれた年にみゆきちゃんが……。",
        "voice": "v102"
      },
      {
        "type": "wait",
